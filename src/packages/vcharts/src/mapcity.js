...
import { getOption } from "../options/mapcity";

const GeneratorMapcity = ({ value, options, onChange, mode, dirlldownQuery, dispatch }) => {
  ...
  return (
    <Vcharts refresh={isRefresh} options={getOption(options, dataSource)} style={{ width: "100%", height: "100%" }} />
  );
};
