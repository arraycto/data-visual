  ...
  return (
    <div className="gc-page">
      <div className="dashboard-banner">
        <video autoPlay={true} loop={true} poster={require("@/assets/banner.jpg")} width="100%" height="100%">
      ...
      <div className="dashboard-typography">
        <Typography>
          ...
          <Paragraph>
            <ul>
              <li>
                <Link to="/workspace/screen" target="_blank">
                  体验大屏版本v2
                </Link>
              </li>
              <li>
                <Link to="/workspace/grid" target="_blank">
                  体验报表版本v2
                </Link>
              </li>
            </ul>
