...
// mock user login
Mock.mock(BASE_URL + "/user/login", "post", {
  role: "admin",
  access_token: "@guid",
...
Mock.mock(BASE_URL + "/datav/screen", "post", {
  data: {
    page: {
      name: "",
      remark: "",
...
Mock.mock(BASE_URL + "/datav/grid", "post", {
  data: {
    page: {
      name: "",
      remark: "",
    ...
    components: [
      {
        ...
        uniqueId: "3217fea5-6f61-4973-8427-6a7ae5fbd37d"
      },
      {
        name: "柱状图",
        icon: "bar",
        ...
        uniqueId: "2c39cd94-2021-4ec7-975a-6b9a109c8342"
      }
    ]
  }
});

Mock.mock(BASE_URL + "/datav/api", "get", {
  "data|2-4": [
    {
      id: "@zip()",
      name: "测试@increment()",
...
Mock.mock(BASE_URL + "/datav/sql", "get", {
  "data|3-8": [
    {
      id: "@zip()",
      name: "测试@increment()",
